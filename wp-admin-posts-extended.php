 ...
 * Description: Gestion editorial para WordPress Admin con filtros por etiquetas, autor y ano, campos ACF, videos embebidos y exportacion Excel.
...
if (!defined('WPM_PLUGIN_VERSION')) {
    define('WPM_PLUGIN_VERSION', '2.5.1');
}
